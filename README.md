[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fastscape-lem/ESPM-course/main?urlpath=lab)
[![Test notebooks](https://github.com/fastscape-lem/ESPM-course/workflows/Test%20notebooks/badge.svg)](https://github.com/fastscape-lem/ESPM-course/actions)

# University of Potsdam Earth Surface Process Modeling Course 2022

This repository contains a collection of [Jupyter](http://jupyter.org/)
notebooks and PDFs for Jean Braun's and Kim Huppert's course on Earth
Surface Process Modeling given in the Summer Fall of 2022
At the University of Potsdam

The course covers:
- a short introduction to numerical modeling using Python
- preparing and using a 1D solution to the SPL (Stream Power Law)
- preparing and using 1D and 2D solutions to the linear diffusion equation
- preparing and using a 2D solution to the SPL using the FastScape algorithm
- using the FastScape-LEM software to solve basic geomorphology questions
...
- [Run on binder](https://mybinder.org/v2/gh/fastscape-lem/ESPM-course/main?urlpath=lab)
...
```bash
$ docker pull fastscape/ESPM-course:latest
```
...
```bash
$ git clone https://github.com/fastscape-lem/ESPM-course
$ cd ESPM-course
$ conda env create -f environment.yml
$ conda activate ESPM-course
```
...
```bash
$ conda env update -n ESPM-course --file environment-dev.yml 
```
